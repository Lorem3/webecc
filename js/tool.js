...
class EC {
    ...
    base64Encode(arr, urlsafe = 0) {
        let r = base64js.fromByteArray(arr, 76);
        return urlsafe && (r = r.replace(/\+/g, "-"), r = r.replace(/\//g, "_"), r = r.replace(/=/g, "")), 
        r;
    }
    base64Decode(str, urlsafe = 0) {
        return urlsafe && (str = (str = (str = str.replace(/-/g, "+")).replace(/_/g, "/")).replace(/=/g, "")), 
